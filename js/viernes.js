$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
     ...
     $('#btn-guardarViernes').click(function(){
            ...
            alert("Campos vacios...")
             ...
             $.ajax({ 
                 ...
                 success: function(e) { 
                     ...
                     window.location.replace('viernes.php');
                 }
             });
        }
     });
     ...
     $('.editar').click(function(){
        var idLunes = $(this).data('dietaviernes');      
        ...
        $('#btn-editarViernes').click(function(){
