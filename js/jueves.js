$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
     ...
     $('#btn-guardarJueves').click(function(){
            ...
            alert("Campos vacios...")
             ...
             $.ajax({ 
                 ...
                 success: function(e) { 
                     ...
                     window.location.replace('jueves.php');
                 }
             });
        }
     });
     ...
     $('.editar').click(function(){
        var idLunes = $(this).data('dietajueves');      
        ...
        $('#btn-editarJueves').click(function(){
