$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
     ...
     $('#btn-guardarSabado').click(function(){
            ...
            alert("Campos vacios...")
             ...
             $.ajax({ 
                 ...
                 success: function(e) { 
                     ...
                     window.location.replace('sabado.php');
                 }
             });
        }
     });
     ...
     $('.editar').click(function(){
        var idLunes = $(this).data('dietasabado');      
        ...
        $('#btn-editarSabado').click(function(){
