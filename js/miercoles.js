$(document).ready(function() {
    ...
    $('#tableDietasMiercoles').DataTable();           
    ...
    $('.eliminar').click(function(){
     ...
     $('#btn-guardarMiercoles').click(function(){
            ...
            alert("Campos vacios...")
             ...
             $.ajax({ 
                 ...
                 success: function(e) { 
                     ...
                     window.location.replace('miercoles.php');
                 }
             });
        }
     });
     ...
     $('.editar').click(function(){
        var idLunes = $(this).data('dietamiercoles');      
        ...
        $('#btn-editarMiercoles').click(function(){
