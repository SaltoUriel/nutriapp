$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
     ...
     $('#btn-guardarDomingo').click(function(){
            ...
            alert("Campos vacios...")
             ...
             $.ajax({ 
                 ...
                 success: function(e) { 
                     ...
                     window.location.replace('domingo.php');
                 }
             });
        }
     });
     ...
     $('.editar').click(function(){
        var idLunes = $(this).data('dietadomingo');      
        ...
        $('#btn-editarDomingo').click(function(){
