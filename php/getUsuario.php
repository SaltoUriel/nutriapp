<?php 
    ...
    if( (isset($_POST['nombre']) && isset($_POST['correo']) && isset($_POST['contrasena']) && isset($_POST['rol']) && isset($_POST['activo']) && isset($_POST['action']) )
        ...
        || (isset($_POST['usuario']) && isset($_POST['nombre']) && isset($_POST['correo']) && isset($_POST['rol']) && isset($_POST['action']))){
        $action = $_POST['action'];
        switch($action){
            ...
            case "update" : $ObjectDashboardConfiguracion->updateUsuario($_POST['usuario'],$_POST['nombre'],$_POST['correo'],$_POST['rol'] ); break;
        }
    }
