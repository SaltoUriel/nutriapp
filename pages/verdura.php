                    ...
                    <div class="col-lg-12 center-block">
                        <div class="col-lg-6 page-header">
                            <div class="col-lg-2 align-baseline">
                                ...
                                <img class="text-icon" src="../img/verduras.png">
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="col-lg-6 page-header">
                            <h1 class=""> <a type="button" class="btn btn-success col-md-offset-7" data-toggle="modal" data-target="#insertModal" id="btn-guardar" >Agregar verdura</a> </h1>
                        </div>
                    </div>
                    <!-- ... Your content goes here ... --> 
                    <div class="row ">
                        <table id="tableVerduras" class="table table-striped">
                            ...
                            <tbody>
                                <?php $ObjectDashboard->mostrarListaVerduras(); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">Verdura</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-guardarVerdura" >Guardar</button>                   
                </div>
            </div>
        </div>  
    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="exampleModalLabel">Editar verdura</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btn-editarVerdura" >Guardar</button>                    
                </div>
            </div>
        </div>  
    </div>
