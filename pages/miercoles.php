...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 center-block">
                        <div class="col-lg-6 page-header">
                            <div class="col-lg-2 align-baseline">
                                ...
                                <img class="text-icon" src="../img/dia.png">
                            </div>
                            <div class="col-lg-3">                                                
                                <h1>Miercoles</h1>                                 
                            </div>
                    ...
                    <div class="row ">
                        <table id="tableDietasMiercoles" class="table table-striped">
                            ...
                            <tbody>
                                <?php $ObjectDashboardDietaSemana->mostrarListaDietaMiercoles(); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-guardarMiercoles" >Guardar</button>                   
                </div>
            </div>
        </div>  
    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btn-editarMiercoles" >Guardar</button>                    
                </div>
            </div>
        </div>  
    </div>
    ...
    <script src="../js/miercoles.js"></script>
    <!-- jQuery -->
