...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="row ">
                        <table id="tableDietasMartes" class="table table-striped">
                            ...
                            <tbody>
                                <?php $ObjectDashboardDietaSemana->mostrarListaDietaMartes(); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-guardarMartes" >Guardar</button>                   
                </div>
            </div>
        </div>  
    </div>
    ...
    <script src="../js/martes.js"></script>
    <!-- jQuery -->
