...
<body>
                    ...
                    <div class="col-lg-12 center-block">
                        <div class="col-lg-6 page-header">
                            <div class="col-lg-2 align-baseline">
                                ...
                                <img class="text-icon" src="../img/granos.png">
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="col-lg-6 page-header">
                            <h1 class=""> <a type="button" class="btn btn-success col-md-offset-7" data-toggle="modal" data-target="#insertModal" id="btn-guardar" >Agregar leguminosa</a> </h1>
                        </div>
                    </div>
                    <!-- ... Your content goes here ... --> 
                    <div class="row ">
                        <table id="tableLeguminosas" class="table table-striped">
                            ...
                            <tbody>
                                <?php $ObjectDashboard->mostrarListaLeguminosas(); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">Leguminosa</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-guardarLeguminosa" >Guardar</button>                   
                </div>
            </div>
        </div>  
    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btn-editarLeguminosa" >Guardar</button>                    
                </div>
            </div>
        </div>  
    </div>
    ...
    <script src="../js/leguminosas.js"></script>
    <!-- jQuery -->
